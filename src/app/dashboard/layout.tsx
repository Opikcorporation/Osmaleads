  ...
  return (
    <div className="grid min-h-screen w-full md:grid-cols-[256px_1fr]">
      ...
      <div className="flex flex-col">
        <header className="flex h-14 items-center justify-end gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6 md:hidden">
          {/* The hamburger menu can be removed or kept as a secondary navigation access point */}
        ...
        <AppBottomNav user={collaborator} />
      </div>
    </div>
  );
}
