...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant that specializes in creating lead profiles from imported data. You will receive lead data in CSV or other text format. Analyze the data and generate a comprehensive profile of the lead, including key information, potential interests, and possible pain points. The profile should be detailed and informative, allowing for quick understanding of the lead's potential.
